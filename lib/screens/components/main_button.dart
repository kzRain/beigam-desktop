...
class MainCircleButton extends StatefulWidget {
  final String title;
  final TextStyle? titleStyle;
  final ButtonState state;
  final Widget? icon;
  ...
  @override
  State<MainCircleButton> createState() => _MainCircleButtonState();
}

class _MainCircleButtonState extends State<MainCircleButton> {
  @override
  Widget build(BuildContext context) {
    final defaultColor = widget.gradiant ?? [AppTheme.red, AppTheme.darkBlue];
    return InkWell(
